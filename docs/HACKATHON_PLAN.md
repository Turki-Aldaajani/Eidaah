...
### 📚 موادي والتقدم — إضافة جديدة

**S1 · المواد الشخصية وتتبع التقدم (الأساس)** — ⚙️ باك اند · SHOULD · يعتمد على G1 وI1 (يعيد استخدام خط المعالجة في I3)
امتداد للسكيما: عمودا owner_id وscope في materials (قيمتان: library للمكتبة العامة / personal لمواد الطالب)، وجدول progress (user_id، material_id، الشرائح المكتملة، متوسط أسئلة المراجعة، آخر نشاط). API لرفع مادة شخصية تُعالَج وتُخزَّن لصاحبها فقط — بدون موافقة أدمن لأنها خاصة — مع نقاط قراءة وتحديث للتقدم.
✅ القبول: المادة الشخصية لا تظهر لغير صاحبها، والتقدم يُحدَّث ويُقرأ عبر الـ API.

**S2 · صفحة «موادي» بواجهة التقدم** — 🖥️ فرونت · SHOULD · يعتمد على S1
شبكة مواد الفصل الدراسي الخاصة بالطالب: زر إضافة مادة، شريط تقدم لكل مادة (نسبة الشرائح المكتملة + متوسط أسئلة المراجعة)، وآخر نشاط. التقدم يغذي لاحقاً ويدجت النقاط (F6) ووكيل المذاكرة (A1) ليقرر وين يركز.
✅ القبول: رفع مادة ← تظهر في «موادي» ← إكمال شرائح أو جولة أسئلة يحرّك شريط التقدم فوراً.
