...
من لوحة الملاحظات، الثلاثة المؤثرة بالعرض فقط: (١) تنقّل الشرائح برقم «٣ / ١٢» وأسهم بدل تراص الصور المصغرة، (٢) التحقق أن لغة المستخدم تُمرَّر فعلاً للنموذج في النسخة المدموجة، (٣) التحقق من سلامة العرض على الجوال. بقية بنود اللوحة الصغيرة مؤجلة لما بعد الهاكاثون.
...
دعوة الأصدقاء والتنافس بالنقاط · مجتمع لكل جامعة يدير مواده بنفسه · تدريب أعمق على أسلوب كل جامعة · تمييز دولة/لهجة المستخدم · بقية بنود لوحة الملاحظات الصغيرة (Footer، FAQ، رسائل الخطأ...) · إعادة بناء لوحة eidaah-plan بدعم السبرينتات.
