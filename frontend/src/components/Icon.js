...
export const ICONS = {
  ...
  settings: '<circle cx="12" cy="12" r="3.1"/><path d="M19.4 13a7.7 7.7 0 0 0 0-2l2-1.5-2-3.4-2.3 1a7.4 7.4 0 0 0-1.8-1L14.8 2.6H10.2L9.7 5.1a7.4 7.4 0 0 0-1.8 1l-2.3-1-2 3.4L3.6 10a7.7 7.7 0 0 0 0 2l-2 1.5 2 3.4 2.3-1c.5.4 1.1.8 1.8 1l.5 2.5h4.6l.5-2.5c.7-.2 1.3-.6 1.8-1l2.3 1 2-3.4z"/>',
};
